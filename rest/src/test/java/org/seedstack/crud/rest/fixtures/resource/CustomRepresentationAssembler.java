...
public class CustomRepresentationAssembler extends BaseAssembler<Customer, CustomerRepresentation> {
    @Override
    public void mergeAggregateIntoDto(Customer customer, CustomerRepresentation customerRepresentation) {
    ...
    @Override
    public void mergeDtoIntoAggregate(CustomerRepresentation customerRepresentation, Customer customer) {
