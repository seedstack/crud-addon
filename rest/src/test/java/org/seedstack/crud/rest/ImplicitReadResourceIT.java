...
public class ImplicitReadResourceIT {
    ...
    public void attributePaginatedList() {
        when().get(baseUrl + "/bugs?sort=id.petName&attribute=id.petName&value=dee-dee&limit=2")
                .then()
                .statusCode(200)
                .body("size", equalTo(2))
    ...
    @Test
    public void list() {
        when().get(baseUrl + "/bugs?sort=id.petName")
                .then()
                .statusCode(200)
    ...
    public void offsetPaginatedList() {
        when().get(baseUrl + "/bugs?sort=id.petName&offset=1&limit=2")
                .then()
                .statusCode(200)
                .body("size", equalTo(2))
                .body("items", hasSize(2))
    ...
    public void pagePaginatedList() {
        when().get(baseUrl + "/bugs?sort=id.petName&page=1&limit=2")
                .then()
                .statusCode(200)
                .body("size", equalTo(2))
