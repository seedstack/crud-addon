...
public class ExplicitResourceIT {
    ...
    public void attributePaginatedList() {
        when().get(baseUrl + "/customers?sort=id.firstName&attribute=id.firstName&value=Jeanne&limit=2")
                .then()
                .statusCode(200)
                .body("size", equalTo(2))
    ...
    public void create() {
        given().body("{\"firstName\":\"Tara\", \"lastName\":\"JOHNSON\"}")
                ...
                .then()
                .statusCode(201)
                .header("Location", baseUrl + "/customers/Tara%20JOHNSON");
    }

    @Test
    public void delete() {
        when()
                .delete(baseUrl + "/customers/Robert DENIRO")
                .then()
                .statusCode(404);
        when()
                .get(baseUrl + "/customers/Robert SMITH")
                .then()
                .statusCode(200);
        when()
                .delete(baseUrl + "/customers/Robert SMITH")
                .then()
                .statusCode(204);
        when()
                .get(baseUrl + "/customers/Robert SMITH")
    ...
    @Test
    public void get() {
        when().get(baseUrl + "/customers/Robert SMITH")
                .then()
                .statusCode(200)
    ...
    @Test
    public void list() {
        when().get(baseUrl + "/customers?sort=id.firstName")
                .then()
                .statusCode(200)
                .body("$", hasSize(3))
    ...
    public void offsetPaginatedList() {
        when().get(baseUrl + "/customers?sort=id.firstName&offset=1&limit=2")
                .then()
                .statusCode(200)
                .body("size", equalTo(2))
                .body("items", hasSize(2))
    ...
    public void pagePaginatedList() {
        when().get(baseUrl + "/customers?sort=id.firstName&page=1&limit=2")
                .then()
                .statusCode(200)
                .body("size", equalTo(2))
    ...
    public void update() {
        given().body("{\"firstName\":\"Robert\", \"lastName\":\"SMITH\", \"age\": 35}")
                .contentType("application/json")
                .when()
                .put(baseUrl + "/customers/Robert SMITH")
                .then()
                .statusCode(200)
                .body("firstName", equalTo("Robert"))
                .body("lastName", equalTo("SMITH"))
